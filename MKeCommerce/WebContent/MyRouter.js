...
jQuery.sap.declare("mk.ecommerce.MyRouter");

sap.ui.core.routing.Router.extend("mk.ecommerce.MyRouter", {
	...
	_findSplitApp : function(oControl) {
		sAncestorControlName = "mainAppContainer";  //mainAppContainer offersContent
